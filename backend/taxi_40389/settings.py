"""
Django settings for taxi_40389 project.
...
WSGI_APPLICATION = 'taxi_40389.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taxi_40389 API",
    "DESCRIPTION": "API documentation for taxi_40389 App",
    "VERSION": "v1",
}
